...
function upcomingGadgetForm() {
    gsap.to(".upcoming-gadget-form", {
        duration: 0.7,
        y: "-78vh",
        ease: Power2.easeOut
    })
...
////////////////////////////////////////////////
function closeUpcomingGadgetForm() {
    gsap.to(".upcoming-gadget-form", {
        duration: 0.7,
        y: "0vh",
        ease: Power1.easeOut
...
function gadgetExpenseForm(){
    gsap.to(".gadget-expense-form", {
        delay: 0.2,
        duration: 0.7,
        y: "-78vh",
        ease: Power2.easeOut
...
//////////////////////////////////
function closeGadgetExpenseForm() {
    gsap.to(".gadget-expense-form", {
        duration: 0.7,
        y: "0vh",
        ease: Power1.easeOut
