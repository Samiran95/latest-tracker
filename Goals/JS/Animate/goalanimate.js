...
function upcominggoalForm() {
    gsap.to(".upcoming-goal-form", {
        duration: 0.7,
        y: "-78vh",
        ease: Power2.easeOut
    })
...
////////////////////////////////////////////////
function closeUpcominggoalForm() {
    gsap.to(".upcoming-goal-form", {
        duration: 0.7,
        y: "0vh",
        ease: Power1.easeOut
...
function goalExpenseForm(){
    gsap.to(".goal-expense-form", {
        delay: 0.2,
        duration: 0.7,
        y: "-78vh",
        ease: Power2.easeOut
